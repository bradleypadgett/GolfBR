...
void AtestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ReturnToMainMenu", IE_Pressed, this, &AtestCharacter::ReturnToMainMenu);
}
...
void AtestCharacter::ReturnToMainMenu() {
...
void AtestCharacter::OnRep_PlayerState() {
	...
	if (OwningPlayerState != nullptr) {
		...
		if (OwningGolfBRPlayerState != nullptr) {
			FString TeamName = OwningGolfBRPlayerState->Team;
